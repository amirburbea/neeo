...
public static class KnownButton
{
    ...
    public static IEnumerable<string> GetNames(KnownButtons buttons)
    {
        ...
        return isSingleFlag
            ...
            : KnownButton.ExtractFlags(value).Select(TextAttribute.GetEnumText);
    }
    ...
    private static IEnumerable<KnownButtons> ExtractFlags(ulong value)
    {
        for (int bits = 0; bits < 64; bits++)
        {
            ...
            if ((value & flag) == flag)
            {
                yield return (KnownButtons)flag;
            }
        }
    }
}
